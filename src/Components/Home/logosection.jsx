...
//       <div className="video_div">
//         <motion.div
//           className={`logo-container ${fixed ? "fixed" : "sticky"}`}
//           animate={fixed ? { top: 0, transform: "translateX(-50%)" } : { top: "50%", transform: "translate(-50%, -50%)" }}
  ...
  return (
    ...
    >
      <div className="video_div">
        <motion.div
          className={`logo-container ${fixed ? "fixed" : "sticky"}`}
          initial={{ opacity: 0.5, width: "150px" }}
          animate={fixed ? { opacity: 1, width: "100%" } : { opacity: 1, width: "150px" }}
